<?php 
     ...
     if(isset($_POST['submit'])){
        ...
        $sql_amount = "UPDATE activite SET payment=(SELECT SUM(paymemt.coin) FROM paymemt where paymemt.activite=activite.name)";
        $result_amount = $conn->query($sql_amount) or die($conn->error);
